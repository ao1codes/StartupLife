                ...
                >
                  <div className="flex items-start gap-3 w-full">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-caveat text-base text-ink leading-tight mb-2">
                        {choice.text}
                      </p>
                      {choice.consequences && (
                        <div className="flex flex-wrap gap-1 text-xs opacity-70">
                          {choice.consequences.funding && (
                            <span className="text-green-pen bg-green-50 px-1 py-0.5 rounded">
                              💰 {choice.consequences.funding > 0 ? '+' : ''}{choice.consequences.funding}
                            </span>
                          )}
                          {choice.consequences.team && (
                            <span className="text-marker-blue bg-blue-50 px-1 py-0.5 rounded">
                              👥 {choice.consequences.team > 0 ? '+' : ''}{choice.consequences.team}
                            </span>
                          )}
                          {choice.consequences.hype && (
                            <span className="text-red-pen bg-red-50 px-1 py-0.5 rounded">
                              🔥 {choice.consequences.hype > 0 ? '+' : ''}{choice.consequences.hype}
                            </span>
                          )}
                          {choice.consequences.progress && (
                            <span className="text-purple-marker bg-purple-50 px-1 py-0.5 rounded">
                              📈 {choice.consequences.progress > 0 ? '+' : ''}{choice.consequences.progress}
                            </span>
                          )}
                        </div>
                      )}
